...
2 — Advisory Framing Check (HARD REJECT): Does the draft state or imply a recommendation to buy, sell, or take a position? Check BOTH direct and third-person implied advisory. Direct advisory — forbidden: "you should", "we recommend", "we'd", "consider adding/selling", "buying/selling opportunity", "be careful", "smart play", "don't panic", "stay long", "stay short", "investors should". Third-person implied advisory — also forbidden: "raised concerns about further [declines/gains]" (implies investors should be worried), "investors to look for alternatives" (implies readers should too), "could signal further [decline/upside]" (speculative direction with implied actionability), "might indicate [a trend]", "appears to suggest [a direction]", "investors closely monitoring" (implies readers should monitor too). Educational framing ("traders watch this level because…") is acceptable. Describing a market reaction as a plain fact ("Bitcoin fell 3%") is acceptable — the test is whether the phrasing implies the reader should react, not merely whether it describes investor behavior.
